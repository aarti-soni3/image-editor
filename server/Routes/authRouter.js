...
]), authMiddlware.isEmailOrUsernameExist, catchAsync(authController.register));
...
router.route('/access').get(authMiddlware.verifyToken, catchAsync(authController.access));
