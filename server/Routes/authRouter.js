...
]), authMiddlware.isEmailOrUsernameExist, asyncHandler(authController.register));
...
router.route('/access').get(authMiddlware.verifyToken, asyncHandler(authController.access));
